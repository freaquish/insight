<template>
  <client-only>
    <section class="block px-4 py-2 fixed inset-x-0 bottom-0 z-10 w-full h-16">
      <div
        class="h-full rounded-lg shadow-md bg-pink-600 pt-2 text-white flex flex-row justify-around "
      >
