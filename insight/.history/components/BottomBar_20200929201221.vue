<template>
  <client-only>
    <section
      class="block px-0 pt-3 border border-b-0 border-l-0 border-r-0 border-gray-300 fixed inset-x-0 bottom-0 z-10 w-full h-16"
    >
      <div
        class="h-full rounded-md shadow-md bg-white  pt-2 text-black flex flex-row justify-around "
      >
        <div
          :class="
            `${
