  ...
  >
    <div class="w-full flex h-auto bg-gray-300 pr-2 py-1 rounded-md">
      <div
        ...
        placeholder="Comment..."
        @input="commentInput"
        class="w-full edit pl-2 font-muli text-gray-700 py-1 pr-1 rounded-md focus:outline-none  bg-gray-300 mr-1"
      ></div>
      <div
        @click="send()"
...
export default Vue.extend({
  props: ['pid'],
  mounted() {
    this.textarea = this.$el.querySelector('.edit') as HTMLDivElement
  },
  data() {
    return {
      commentText: undefined as string | undefined,
      row: 1,
      textarea: undefined as HTMLDivElement | undefined
    }
  },
  methods: {
    ...
    commentInput(): void {
      ...
      this.commentText = this.textarea.innerText
      if (
        ...
        if (splitted != null && splitted.length > 0) {
          ...
          this.textarea.innerHTML = this.commentText
