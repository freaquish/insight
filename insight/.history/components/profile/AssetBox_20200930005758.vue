<template>
  <div @click="clicked" class="w-full h-48 border border-gray-200  mx-1 my-1">
    <img
...
export default {
  ...
  data() {
    return {
      ...
      type: undefined,
      audImg:
        'https://firebasestorage.googleapis.com/v0/b/social-express-103904.appspot.com/o/assets%2Flogo.jpeg?alt=media&token=ac16b5c8-42aa-45a2-ae29-05809fba116f'
    }
  },
  methods: {
    insertAsset: function() {
      if (
        ...
        if (this.post.assets.text.fontName != undefined) {
          this.$el.style.setProperty(
            'font-family',
            this.post.assets.text.fontName
          )
        }
      }
    },
