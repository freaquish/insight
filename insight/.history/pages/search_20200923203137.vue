  ...
  <div class="w-full h-full grided bg-tint-purple">
    ...
    <div class="w-full fixed flex flex-col pt-4 px-2">
      ...
      <div class="w-full h-auto flex">
        <SearchTab :text="'All'" ::active="selectedTab === 'All'" />
        <SearchTab :text="'Tag'" ::active="selectedTab === 'Tag'" />
        <SearchTab :text="'User'" ::active="selectedTab === 'User'" />
        <SearchTab :text="'Hobby'" ::active="selectedTab === 'Hobby'" />
      </div>
    </div>
