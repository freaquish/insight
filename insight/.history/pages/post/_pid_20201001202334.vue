<template>
  <div class="w-full h-full pb-16 flex flex-col overflow-y-scroll">
    ...
    <div
      ...
      "
      class="w-full h-full overflow-x-hidden pb-16 pt-2"
    >
      <div
    ...
    <div
      v-if="
        this.post.footer != undefined && this.post.footer.comments != undefined
      "
      class="w-full h-12 block fixed bg-transparent inset-x-0 bottom-0 mb-16"
    >
      <CommentInput />
    </div>
  </div>
