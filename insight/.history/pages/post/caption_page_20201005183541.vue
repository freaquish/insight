  ...
  >
    ...
    <div class="w-full h-auto flex flex-col pt-2 px-4">
      ...
      <div
        ...
        id="caption-editor"
        class="w-full px-2 py-2 focus:outline-none text-montserrat font-lato border-2 border-l-0 border-r-0 border-t-0 border-white"
      ></div>
      <p class="mt-4 font-lato text-white"></p>
    </div>
