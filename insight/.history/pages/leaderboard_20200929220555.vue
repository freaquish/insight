<template>
  <div class="bg w-full h-full min-h-screen">
    <!-- Header -->
    <div class="fixed w-full flex pt-4 px-4">
      <span
        @click="$router.go(-1)"
    ...
    <!-- Hobby -->
    <div class="fixed block w-full mt-8 px-4 overflow-x-scroll ">
      <div class="flex">
    ...
    <div
      ...
      style="height:82vh;border-top-right-radius:1rem;border-top-left-radius:1rem;"
    >
